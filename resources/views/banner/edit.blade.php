    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <div class="form-group mb-3">
                ...
                <img src="{{ asset('uploads/banner/'. $banner->gambar_banner) }}" height="90" width="100" class="mt-3" >
            </div>
            <div class="form-group mb-3">
                <label for="">Judul Banner 1</label>
                <input type="text"  name="judul_banner1" value="{{ $banner->judul_banner1 }}">
            </div>
            <div class="form-group mb-3">
                <label for="">Judul Banner 2</label>
                <input type="text"  name="judul_banner2" value="{{ $banner->judul_banner2 }}">
            </div>
            <div class="form-group mb-3">
                <label for="">Judul Banner 3</label>
                <input type="text"  name="judul_banner3" value="{{ $banner->judul_banner3 }}">
            </div>
