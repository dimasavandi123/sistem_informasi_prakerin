    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <div class="form-group mb-3">
                ...
                <img src="{{ asset('uploads/berita/'. $berita->cover_berita) }}" height="90" width="100" class="mt-3" >
            </div>
            <div class="form-group mb-3">
                <label for="">Gambar Berita</label>
                <input type="file"  name="gambar_berita">
                <img src="{{ asset('uploads/berita/'. $berita->gambar_berita) }}" height="90" width="100" class="mt-3" >
            </div>
            <div class="form-group mb-3">
                <label for="">Artikel Berita</label>
                <input id="artikel_berita" type="hidden" name="artikel_berita" value="{{ $berita->artikel_berita }}">
