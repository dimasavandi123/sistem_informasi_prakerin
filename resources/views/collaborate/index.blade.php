...
<main>
    ...
    <h1 class="title">Table Kerja Sama</h1>
    <ul class="breadcrumbs">
        ...
        @else
            <div class="btn-group btn-group-sm d-flex justify-content-end" role="group" aria-label="Basic mixed styles example">
                <a type="button" href="{{ route('collaborate.create') }}" class="btn btn-primary"><i class='bx bxs-folder-plus'></i>Tambah Data</a>
                ...
                <table class="table table-striped table-responsive ">
                    ...
                    <tbody>
                        @foreach ($collaborate as $no => $clb)
                            <tr>
                                <input type="hidden" class="delete_id" value="{{ $clb->id }}">
                                <th>{{ $no+1 }}</th>
                                ...
                                <td>
                                    <form action="{{ route('collaborate.destroy',$clb->id) }}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <div class="btn-group">
                                        <a href="{{ route('collaborate.edit',$clb->id) }}" class="btn btn-warning btn-sm"><i class='bx bxs-edit'></i></a>
