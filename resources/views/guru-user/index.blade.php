...
<main>
    ...
    <h1 class="title">Data User Guru</h1>
    <ul class="breadcrumbs">
        ...
        <div class="btn-group btn-group-sm d-flex justify-content-end" role="group" aria-label="Basic mixed styles example">
            <a type="button" href="{{ route('guru-user.create') }}" class="btn btn-primary"><i class='bx bxs-folder-plus'></i>Tambah Data</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('guru-user.destroy',$item->id) }}" method="POST">
                                        ...
                                        @csrf
                                        <div class="btn-group">
                                            <a href="{{ route('guru-user.edit',$item->id) }}" class="btn btn-warning btn-sm"><i class='bx bxs-edit'></i></a>
