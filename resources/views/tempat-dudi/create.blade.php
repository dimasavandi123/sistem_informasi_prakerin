...
@section('content')
<main>
    <h1 class="title">Form User Siswa</h1>
    ...
    <div class="card mt-3">
        <div class="card-body">
            @if (session('success'))
                ...
                @endif
            <form action="{{ route('tempat-dudi.store') }}" method="POST">
            @csrf
            <div class="form-group mb-3">
                <label for="">Tempat Prakerin</label>
                <input type="text" placeholder="Contoh Bengkel..." name="nama_dudi">
            </div>
            <div class="form-group mb-3">
                <label for="">Nama Pimpinan</label>
                <input type="text" placeholder="Contoh Avandi" name="nama_pimpinan">
            </div>
            <div class="form-group mb-3">
                <label for="">Alamat Dudi</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="alamat_dudi" placeholder="Contoh Wonodadi RT 003 RW 006,Plantungan,Kendal"></textarea>
            </div>
            <div class="form-group mb-3">
                <label for="">Jumlah Kuota</label>
                <input type="number" placeholder="Max 12" name="jmlh_kuota" max="12 required">
            </div>
            <div class="form-group mb-3">
                <label for="">Kuota Terisi</label>
                <input type="number" placeholder="Isi Angka 0 Jika Tempat Dudi Belum Terisi" name="kuota_terisi" max="12 required" >
            </div>
            <div class="form-group mb-3">
