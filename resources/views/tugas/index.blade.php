                ...
                <ul class="nav nav-tabs">
                  ...
                  <div class="row">
                       ...
                       <div class="col-12 col-md-4 col-lg-3" >
                        <a href="{{ route('tugas.show',$tgs->id) }}" class="text-dark">
                            <div class="card card-s mt-3" style="width: auto;">
                                <div class="card-body">
                                  ...
                                  @if($tgs->isExpired())
                                  <span class="badge rounded-pill bg-danger">Tugas Terlewati</span>
                                  @else
                                  <span  class="badge rounded-pill bg-warning">Belum Dikerjakan</span>
                                  @endif
                                  <hr>
                                  <p class="fw-lighter h6">Deadline : {{ \Carbon\Carbon::parse($tgs->deadline)->isoFormat('dddd, D MMM Y')}}</p>
                                </div>
                            </div>
                        </a>
                        </div>
